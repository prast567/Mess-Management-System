...
include"header.php";
 ...
 $query="INSERT into coupon (id,Name,room,Menu,Breakfast,Lunch,Tea,TeaSnacks,Snacks,Dinner) VALUES ('$id','$name','$room','$menu','$breakfast','$lunch','$tea','$teasnacks','$snacks','$dinner')";
