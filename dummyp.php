...
<body>
    ...
    <strong>  <a href="optionusers.php">Home/</a><a href="Purchases.php">Purchases/</a><a href="dummyp.php">DummyPurchases</a></strong>
...
// }
  if(isset($_POST['view']))
  {
        ...
        $query = "select * from dummypurchases where Date='$newday' ";
...
if(isset($_POST['submit']))
{
  ...
  $esp = $_POST['esp'];
  $esu = $_POST['esu'];
  $query1 = "select Date from dummypurchases";
  ...
  if(!is_null($date))
  {
    $query = "update dummypurchases set Expenditure_Paid='$exp',Expenditure_Unpaid='$exu',Establishment_Paid='$esp',Establishment_Unpaid='$esu' where Date='$date'";
  }
  else {
...
?>
  ...
  <section>
    <font color="white">
    <form id="form" action="dummyp.php" method="post">
      <li id="date">
